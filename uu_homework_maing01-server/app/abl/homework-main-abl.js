...
const Errors = require("../api/errors/homework-main-error.js");
...
const logger = LoggerFactory.get("HomeworkMainAbl");

class HomeworkMainAbl {
  constructor() {
